...
public class LuceneModule extends AbstractInternalModule {
    ...
    public static final FunctionDef[] functions = {
        ...
        new FunctionDef(InspectIndex.signatures[1], InspectIndex.class),
        ...
        new FunctionDef(FacetSearch.signatures[2], FacetSearch.class),
        new FunctionDef(FacetSearch.signatures[3], FacetSearch.class),
        new FunctionDef(FacetSearch.signatures[4], FacetSearch.class),

        new FunctionDef(GetField.signatures[0], GetField.class),

        new FunctionDef(GetIndexFields.signatures[0], GetIndexFields.class),
        new FunctionDef(GetIndexFields.signatures[1], GetIndexFields.class)
    };
