...
/**
 * Defines the base interface for collection triggers. Triggers are registered
 * through the collection configuration file, called "collection.xconf", which
 * should be stored in the corresponding database collection. If a collection
 * configuration file is found in the collection, it will be parsed and any
 * triggers will be created and configured. The
 * {@link #configure(DBBroker, Collection, Map) configure} method is called once
 * on each trigger.
 * 
 * Triggers listen to events. Currently, there are five events to which triggers
 * may be attached:
 * 
 * <table border="0">
 * <tr>
 ...
 * <td>Fired, whenever an existing document is updated, i.e. replaced with a new
 * version.</td>
 * </tr>
 * <tr>
 ...
 * </table>
 * 
 * The document-related events are handled by the sub-interface
 * {@link org.exist.collections.triggers.DocumentTrigger}, collection-related
 * events are handled by
 * {@link org.exist.collections.triggers.CollectionTrigger}.
 * 
