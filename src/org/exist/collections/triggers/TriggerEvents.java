...
public class TriggerEvents {
    ...
    public enum EVENTS {
        CREATE_COLLECTION, UPDATE_COLLECTION, COPY_COLLECTION, MOVE_COLLECTION, DELETE_COLLECTION,

        CREATE_DOCUMENT, UPDATE_DOCUMENT, COPY_DOCUMENT, MOVE_DOCUMENT, DELETE_DOCUMENT
    }

    private final static String EVENTS_STRING[] = { "CREATE-COLLECTION", "UPDATE-COLLECTION", "COPY-COLLECTION", "MOVE-COLLECTION", "DELETE-COLLECTION",

    "CREATE-DOCUMENT", "UPDATE-DOCUMENT", "COPY-DOCUMENT", "MOVE-DOCUMENT", "DELETE-DOCUMENT" };

    private final static EVENTS _EVENTS_[] = { EVENTS.CREATE_COLLECTION, EVENTS.UPDATE_COLLECTION, EVENTS.COPY_COLLECTION, EVENTS.MOVE_COLLECTION, EVENTS.DELETE_COLLECTION,

    EVENTS.CREATE_DOCUMENT, EVENTS.UPDATE_DOCUMENT, EVENTS.COPY_DOCUMENT, EVENTS.MOVE_DOCUMENT, EVENTS.DELETE_DOCUMENT };
    ...
    public final static String OLD_EVENTS_STRING[] = { "STORE", "UPDATE", "REMOVE", };
