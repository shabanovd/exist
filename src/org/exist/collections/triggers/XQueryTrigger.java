...
public class XQueryTrigger extends SAXTrigger implements DocumentTrigger, CollectionTrigger {
    ...
    /**
     * @link org.exist.collections.Trigger#configure(org.exist.storage.DBBroker,
    ...
    public void configure(DBBroker broker, Collection parent, Map<String, List<?>> parameters) throws TriggerException {
        ...
        if (parameters != null) {
            ...
            for (final Iterator itParamName = parameters.keySet().iterator(); itParamName.hasNext();) {
                ...
                // make any other parameters available as external variables for
                // the query
                else {
...
//    }
    ...
    /*
     * public String toString() { return "collection=" + collection + "\n" +
