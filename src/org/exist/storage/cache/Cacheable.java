 ...
 * 
 * Each object should provide a unique key, an internal reference counter, and a
 * timestamp marker (used to measure how long the object has stayed in the
 * cache). It depends on the concrete cache implementation if and how these
 * fields are used.
 * 
...
public interface Cacheable {
    ...
    /**
     * Called before the object is released by the cache. The object should
     * prepare to be garbage collected. All unwritten data should be flushed to
     * disk.
     */
     ...
     * 
     * Called before an object is actually removed. Return false to avoid being
     * removed.
     * 
