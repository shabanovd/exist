...
public class NativeBroker extends DBBroker {
     ...
     * @throws TriggerException
     */
    private boolean _removeCollection(final Txn transaction, final Collection collection) throws PermissionDeniedException, IOException, TriggerException {
        ...
        try {
            ...
            synchronized(collectionsCache) {
                ...
                for(final Iterator<XmldbURI> i = collection.collectionIterator(this); i.hasNext(); ) {
                    ...
                    try {
                        _removeCollection(transaction, childCollection);
