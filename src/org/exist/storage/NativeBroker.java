...
public class NativeBroker extends DBBroker {
    ...
    public List<String> findCollectionsMatching(String regexp) {
        ...
        try {
            ...
            LOG.warn("Failed to acquire lock on " + collectionsDb.getFile().getName());
            //return null;
        } catch (final TerminatedException | BTreeException | IOException e) {
     ...
     */
    private Collection openCollection(XmldbURI uri, long addr, LockMode lockMode) throws PermissionDeniedException {
    ...
    public boolean removeCollection(final Txn txn, Collection collection) throws PermissionDeniedException, IOException, TriggerException {
        ...
        if (trashManager != null) {
            ...
            if (destination != null) {
                ...
                try {
                    moveCollection(txn, collection, destination, collection.getURI().lastSegment());
        ...
        try {
            ...
            synchronized(collectionsCache) {
                ...
                if(!isRoot) {
                    ...
                    if(txn != null) {
                        txn.registerLock(parentCollection.getLock(), LockMode.WRITE_LOCK);
                    }
...
//        }
    ...
    public StoredNode objectWith(final Document doc, final NodeId nodeId) {
        return (StoredNode) new DOMTransaction(this, domDb, LockMode.READ_LOCK) {
            @Override
            public Object start() {
    ...
    protected void rebuildIndex(byte indexId) {
        ...
        } catch (LockException | DBException | IOException | TerminatedException e) {
