 ...
 * @author wolf
 */
public class IndexInfo implements org.exist.collections.IndexInfo {
    ...
    protected void setReader(XMLReader reader, EntityResolver entityResolver) throws SAXException {
    ...
    protected void setDOMStreamer(DOMStreamer streamer) {
