...
public interface Lock extends Debuggable {
    ...
    /**
     * Acquire a lock for read or write. mode is one of {@link #READ_LOCK} or
     * {@link #WRITE_LOCK}.
     * 
     * @param mode
     * @throws LockException
    ...
    /**
     * Attempt to acquire a lock for read or write. This method will fail
    ...
    /**
     * Check if the specified thread holds either a write or a read lock on the
     * resource.
     * 
     * @param owner
     *            the thread
    ...
    /**
     * Wake up waiting threads and recompute dependencies. Currently used to
     * rerun deadlock detection.
     */
    public void wakeUp();
